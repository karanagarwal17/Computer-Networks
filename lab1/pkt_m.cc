...
int Pkt::getSrcAdd() const
{
    return this->srcAdd;
}

void Pkt::setSrcAdd(int srcAdd)
{
    this->srcAdd = srcAdd;
}

int Pkt::getDestAdd() const
{
    return this->destAdd;
}

void Pkt::setDestAdd(int destAdd)
{
...
int PktDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='s' && strcmp(fieldName, "srcAdd")==0) return base+2;
...
std::string PktDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 2: return long2string(pp->getSrcAdd());
...
bool PktDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 2: pp->setSrcAdd(string2long(value)); return true;
