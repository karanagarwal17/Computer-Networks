...
int DL_PDU::getDid() const
{
    return this->did;
}

void DL_PDU::setDid(int did)
{
    this->did = did;
}
...
int DL_PDU::getDestAdd() const
{
    return this->destAdd;
}

void DL_PDU::setDestAdd(int destAdd)
{
...
int DL_PDUDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='d' && strcmp(fieldName, "did")==0) return base+0;
...
std::string DL_PDUDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    DL_PDU *pp = (DL_PDU *)object; (void)pp;
    switch (field) {
        case 0: return long2string(pp->getDid());
...
bool DL_PDUDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    DL_PDU *pp = (DL_PDU *)object; (void)pp;
    switch (field) {
        case 0: pp->setDid(string2long(value)); return true;
